...
}, publicRegistrationEnabled: config.publicRegistrationEnabled, cookieSecure: config.cookieSecure, publicOrigin: config.publicOrigin, installerVersion: config.installerVersion, logger: true });
